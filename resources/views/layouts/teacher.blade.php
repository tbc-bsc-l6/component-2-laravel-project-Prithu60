...
<div class="min-h-screen flex">
    ...
    <!-- ================= SIDEBAR ================= -->
    <aside class="w-64 shrink-0 bg-gradient-to-b from-[#070B18] to-[#0B1635] text-white">
        ...
        <div class="px-6 py-6 flex items-center gap-3 border-b border-white/10">
            ...
            <div>
                <div class="font-semibold">SM Info</div>
        ...
        <div class="mt-auto px-4 pb-6">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button class="w-full rounded-xl bg-white/10 px-4 py-3 text-sm hover:bg-white/20">
                    Logout
                </button>
            </form>
        </div>
